...
# EMLX Backend Benchmark
#
# Run with: `elixir examples/benchmark_emlx.exs`
...
IO.puts("\n" <> String.duplicate("=", 80))
IO.puts("EMLX Backend Benchmark (Apple Silicon MPS)")
...
case result do
  {:ok, image} ->
    ...
    File.write!("benchmark_emlx_time.txt", "#{elapsed_ms}")
    IO.puts("Timing saved to: benchmark_emlx_time.txt")
